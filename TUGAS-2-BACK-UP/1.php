        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                var icMarker = L.icon({
                    ...
                    iconAnchor: [8 , 40],
                    popupAnchor: [12, -28],
                    // shadowUrl: 'assets/images/icon/shadow.png',
                    // shadowSize: [36, 40],
                    // shadowAnchor: [8, 2]
                });
                ...
                //             var marker = 'marker'+data[i]['id'];
                //             viewMarker(marker, data[i]['lat'], data[i]['lng']);
                //             alert(marker);
                //         }
                //     }
                // });
                ...
                // //function marker
                // function viewMarker(marker, lat, lng){
                //     marker = L.marker([lat, lng], {icon: icMarker}).addTo(mymap);
                //     marker.bindPopup('koordinat Lat & lng'[lat, lng]);
                // }
                ...
                mymap.on('click',function(e){
                    ...
                    // alert("lat:"+e.latlng.lat+",lng:"+e.latlng.lng+", Zoom :"+mymap.getZoom());
                    /*
                        POST DATA
                    */
