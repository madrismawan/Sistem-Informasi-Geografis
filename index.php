    ...
    <div id="main-wrapper">
                            ...
                            <div class="card-block">
                                ...
                                <form >
                                    <div class="mb-3">
                                        ...
                                        <input id="viewNama" type="text" placeholder="Nama Kabupaten"  class="form-control"  disabled >
                                    </div>
                                    <!-- <div class="mb-3">
        ...
        <script type="text/javascript">  
           $(document).ready(function(){
            ...
            var mymap = L.map('gmaps').setView([-8.619778, 115.206110], 13);
            L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
                    attribution: 'Adalah API Favoritku',
                    maxZoom: 18,
                    id: 'mapbox/streets-v11',
            ...
            mymap.on('mousemove', function(e){
            document.getElementById("info").innerHTML="Titik Koordinat :(" + e.latlng.lat + "," + e.latlng.lng+")";
            });

            $.getJSON("bali-kabupaten.geojson", function(data){
            var dataLayer = L.geoJson(data, {
                onEachFeature: function(feature, featureLayer) {
                    // return {color: feature.properties.color};
                    featureLayer.bindPopup(feature.properties.NAME_2);  
                }
            }).addTo(mymap);
